...
import {ssz, SyncPeriod} from "@lodestar/types";
 ...
 */
export class BestPartialEpochLightClientUpdateRepository extends Repository<SyncPeriod, PartialLightClientUpdate> {
